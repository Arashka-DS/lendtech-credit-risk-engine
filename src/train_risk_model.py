...
# Generate Synthetic Lend-Tech Data
np.random.seed(42)
n_samples = 5000
...
# Train & Calibrate via 5-Fold CV (Scikit-Learn 1.5+)
...
def calculate_ks(y_true, y_prob):
    ...
    ks_stat, _ = ks_2samp(df[df['true'] == 1]['prob'], df[df['true'] == 0]['prob'])
    return ks_stat
...
# Baseline extraction for PSI calculations
